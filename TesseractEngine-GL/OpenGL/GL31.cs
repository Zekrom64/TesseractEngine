...
namespace Tesseract.OpenGL {
	...
	public class GL31 : GL30 {
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public uint GetUniformIndices(uint program, string name) => GL.ARBUniformBufferObject!.GetUniformIndices(program, name);

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public Span<uint> GetUniformIndices(uint program, Span<uint> indices, params string[] names) => GL.ARBUniformBufferObject!.GetUniformIndices(program, indices, names);

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public Span<uint> GetUniformIndices(uint program, params string[] names) => GL.ARBUniformBufferObject!.GetUniformIndices(program, new uint[names.Length], names);
