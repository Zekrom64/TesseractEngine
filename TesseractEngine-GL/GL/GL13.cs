...
namespace Tesseract.GL {
	public class GL13 : IGLObject {

		public GL GL { get; }
		public GL13Functions Functions { get; }

		public GL13(GL gl, IGLContext context) {
			GL = gl;
			Functions = new GL13Functions();
			Library.LoadFunctions(name => context.GetGLProcAddress(name), Functions);
		}

		public int ActiveTexture {
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			set => Functions.glActiveTexture((uint)(GLEnums.GL_TEXTURE0 + value));
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		public int ClientActiveTexture {
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			set => Functions.glClientActiveTexture((uint)(GLEnums.GL_TEXTURE0 + value));
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			get => (int)(GL.GL11.GetInteger(GLEnums.GL_CLIENT_ACTIVE_TEXTURE) - GLEnums.GL_TEXTURE0);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public void CompressedTexImage1D(GLTextureTarget target, int level, GLInternalFormat internalFormat, int width, int border, int imageSize, IntPtr data) => Functions.glCompressedTexImage1D((uint)target, level, (uint)internalFormat, width, border, imageSize, data);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public void CompressedTexImage2D(GLTextureTarget target, int level, GLInternalFormat internalFormat, int width, int height, int border, int imageSize, IntPtr data) => Functions.glCompressedTexImage2D((uint)target, level, (uint)internalFormat, width, height, border, imageSize, data);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public void CompressedTexImage3D(GLTextureTarget target, int level, GLInternalFormat internalFormat, int width, int height, int depth, int border, int imageSize, IntPtr data) => Functions.glCompressedTexImage3D((uint)target, level, (uint)internalFormat, width, height, depth, border, imageSize, data);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public void GetCompressedTexImage(GLTextureTarget target, int lod, IntPtr img) => Functions.glGetCompressedTexImage((uint)target, lod, img);

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public Span<T> GetCompressedTexImage<T>(GLTextureTarget target, int lod, in Span<T> img) where T : unmanaged {
			unsafe {
				fixed(T* pImg = img) {
					Functions.glGetCompressedTexImage((uint)target, lod, (IntPtr)pImg);
				}
			}
			return img;
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public void SampleCoverage(float value, bool invert) => Functions.glSampleCoverage(value, (byte)(invert ? 1 : 0));
