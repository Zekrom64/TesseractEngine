...
namespace Tesseract.Vulkan {
	...
	public class VKDescriptorPool : IVKDeviceObject, IVKAllocatedObject, IDisposable, IPrimitiveHandle<ulong> {

		public VKObjectType ObjectType => VKObjectType.DescriptorPool;
