...
namespace Tesseract.Vulkan.Native {
	...
	public delegate VKResult PFN_vkCreateInstance([In] ref VKInstanceCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkInstance instance);
	...
	public delegate VKResult PFN_vkCreateDevice(VkPhysicalDevice physicalDevice, [In] ref VKDeviceCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkDevice device);
	...
	public delegate VKResult PFN_vkAllocateMemory(VkDevice device, [In] ref VKMemoryAllocateInfo allocateInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkDeviceMemory memory);
	...
	public delegate VKResult PFN_vkCreateFence(VkDevice device, [In] ref VKFenceCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkFence fence);
	...
	public delegate VKResult PFN_vkCreateSemaphore(VkDevice device, [In] ref VKSemaphoreCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkSemaphore semaphore);
	...
	public delegate VKResult PFN_vkCreateEvent(VkDevice device, [In] ref VKEventCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkEvent _event);
	...
	public delegate VKResult PFN_vkCreateQueryPool(VkDevice device, [In] ref VKQueryPoolCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkQueryPool queryPool);
	...
	public delegate VKResult PFN_vkCreateBuffer(VkDevice device, [In] ref VKBufferCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkBuffer buffer);
	...
	public delegate VKResult PFN_vkCreateBufferView(VkDevice device, [In] ref VKBufferViewCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkBufferView view);
	...
	public delegate VKResult PFN_vkCreateImage(VkDevice device, [In] ref VKImageCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkImage image);
	...
	public delegate VKResult PFN_vkCreateImageView(VkDevice device, [In] ref VKImageViewCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkImageView view);
	...
	public delegate VKResult PFN_vkCreateShaderModule(VkDevice device, [In] ref VKShaderModuleCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkShaderModule shaderModule);
	...
	public delegate VKResult PFN_vkCreatePipelineCache(VkDevice device, [In] ref VKPipelineCacheCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkPipelineCache pipelineCache);
	...
	public delegate VKResult PFN_vkCreatePipelineLayout(VkDevice device, [In] ref VKPipelineLayoutCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkPipelineLayout pipelineLayout);
	...
	public delegate VKResult PFN_vkCreateSampler(VkDevice device, [In] ref VKSamplerCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkSampler sampler);
	...
	public delegate VKResult PFN_vkCreateDescriptorSetLayout(VkDevice device, [In] ref VKDescriptorSetLayoutCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkDescriptorSetLayout setLayout);
	...
	public delegate VKResult PFN_vkCreateDescriptorPool(VkDevice device, [In] ref VKDescriptorPoolCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkDescriptorPool descriptorPool);
	...
	public delegate VKResult PFN_vkAllocateDescriptorSets(VkDevice device, [In] ref VKDescriptorSetAllocateInfo allocateInfo, [NativeType("VkDescriptorSet*")] IntPtr pDescriptorSets);
	...
	public delegate VKResult PFN_vkCreateFramebuffer(VkDevice device, [In] ref VKFramebufferCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkFramebuffer framebuffer);
	...
	public delegate VKResult PFN_vkCreateRenderPass(VkDevice device, [In] ref VKRenderPassCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkRenderPass renderPass);
	...
	public delegate VKResult PFN_vkCreateCommandPool(VkDevice device, [In] ref VKCommandPoolCreateInfo createInfo, [NativeType("const VkAllocationCallbacks*")] IntPtr pAllocator, out VkCommandPool commandPool);
	...
	public delegate VKResult PFN_vkAllocateCommandBuffers(VkDevice device, [In] ref VKCommandBufferAllocateInfo allocateInfo, [NativeType("VkCommandBuffer*")] IntPtr pCommandBuffers);
	...
	public delegate VKResult PFN_vkBeginCommandBuffer(VkCommandBuffer commandBuffer, [In] ref VKCommandBufferBeginInfo beginInfo);
	...
	public delegate void PFN_vkCmdClearColorImage(VkCommandBuffer commandBuffer, VkImage image, VKImageLayout imageLayout, [In] ref VKClearColorValue color, uint rangeCount, [NativeType("const VkImageSubresourceRange*")] IntPtr pRanges);
	public delegate void PFN_vkCmdClearDepthStencilImage(VkCommandBuffer commandBuffer, VkImage image, VKImageLayout imageLayout, [In] ref VKClearDepthStencilValue depthStencil, uint rangeCount, [NativeType("const VkImageSubresourceRange*")] IntPtr pRanges);
	...
	public delegate void PFN_vkCmdBeginRenderPass(VkCommandBuffer commandBuffer, [In] ref VKRenderPassBeginInfo renderPassBegin, VKSubpassContents contents);
