...
namespace Tesseract.Vulkan {
	...
	/// <summary>
	/// An exception for an error generated by the Vulkan API.
	/// </summary>
	public class VulkanException : Exception {

		/// <summary>
		/// Gets the string representation of a <see cref="VKResult"/>.
		/// </summary>
		/// <param name="result">The result to get the string for</param>
		/// <returns>A readable string describing the result</returns>
	...
	/// <summary>
	/// Container for a <see cref="VKAllocationCallbacks"/> structure that stores the native form. This avoids
	/// requiring marshalling its delegates every time it is required and allows it to be passed in a nullable form.
	/// </summary>
