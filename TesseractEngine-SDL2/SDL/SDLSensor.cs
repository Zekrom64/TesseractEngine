...
namespace Tesseract.SDL {
	...
	public struct SDLSensorDevice {
		...
		public string Name => MemoryUtil.GetStringASCII(SDL2.Functions.SDL_SensorGetDeviceName(DeviceIndex));
	...
	public class SDLSensor : IDisposable {
		...
		public string Name => MemoryUtil.GetStringASCII(SDL2.Functions.SDL_SensorGetName(Sensor.Ptr));
