...
namespace Tesseract.SDL.Native {
	...
	public delegate SDLBool PFN_SDL_HasIntersection([In] ref SDLRect a, [In] ref SDLRect b);
	/// <summary>
	...
	public delegate SDLBool PFN_SDL_IntersectRect([In] ref SDLRect a, [In] ref SDLRect b, out SDLRect result);
	/// <summary>
	...
	public delegate void PFN_SDL_UnionRect([In] ref SDLRect a, [In] ref SDLRect b, out SDLRect result);
	/// <summary>
	...
	public delegate SDLBool PFN_SDL_IntersectRectAndLine([In] ref SDLRect rect, ref int x1, ref int y1, ref int x2, ref int y2);
	...
	public delegate IntPtr PFN_SDL_GetClosestDisplayMode(int displayIndex, [In] ref SDLDisplayMode mode, out SDLDisplayMode closest);
	public delegate int PFN_SDL_GetWindowDisplayIndex([NativeType("SDL_Window*")] IntPtr window);
	public delegate int PFN_SDL_SetWindowDisplayMode([NativeType("SDL_Window*")] IntPtr window, [In] ref SDLDisplayMode mode);
